...
hi Normal           guifg=#FFFFFF   ctermfg=15  guibg=#22282A   ctermbg=235
"hi CursorLine       guibg=#32383A
"hi CursorColumn     guibg=#32383A
"hi Search           guibg=#808080
hi Visual           guifg=#FFFFFF   ctermfg=15  guibg=#4F6164   ctermbg=66
hi VisualNOS        guifg=#FFFFFF   ctermfg=15  guibg=#4F6164   ctermbg=66
hi Identifier       guifg=#FFFFFF   ctermfg=15
hi Number           guifg=#FFCD22   ctermfg=226
hi Operator         guifg=#E8E2B7   ctermfg=223
hi String           guifg=#EC7600   ctermfg=166
hi FoldColumn       guifg=#FFFFFF   ctermfg=15  guibg=#394144   ctermbg=238
hi LineNr           guifg=#3F4E49   ctermfg=238 guibg=#293134   ctermbg=236
...
hi WarningMsg       guifg=#FFCD22   ctermfg=226
hi Folded           guifg=#808080   ctermfg=244 guibg=#1C2325   ctermbg=235
hi PMenu            guifg=#CCCCFF   ctermfg=147 guibg=#1C2325   ctermbg=235
hi PMenuSel                                     guibg=#2C3335   ctermbg=235
